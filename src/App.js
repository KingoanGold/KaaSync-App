...
export default function App() {
  ...
  // NOUVEAUX ÉTATS POUR LE CHAT ET NOTIFICATIONS
          ...
          <div className="animate-in fade-in duration-500 p-6 mt-4">
            ...
            <div className="flex flex-col items-center mb-10 relative">
               ...
               <div className="flex flex-col w-full max-w-xs items-center gap-3 mt-6">
                 ...
                 {/* BOUTON SAUVEGARDE GOOGLE + TEXTE */}
                 {user?.isAnonymous && (
                   <div className="w-full text-center space-y-2 mt-2">
                     ...
                     <p className="text-[10px] text-slate-400 font-medium leading-tight px-2">
                       Connectez un compte pour sauvegarder définitivement votre code unique, votre Duo et toutes vos créations.
                     </p>
                   </div>
                 )}
